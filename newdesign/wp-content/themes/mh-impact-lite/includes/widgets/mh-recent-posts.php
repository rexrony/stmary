...
class mh_impact_lite_recent_posts extends WP_Widget {
    function __construct() {
		parent::__construct(
			'mh_impact_lite_recent_posts', esc_html_x('MH Recent Posts', 'widget name', 'mh-impact-lite'),
			array('classname' => 'mh_impact_lite_recent_posts', 'description' => esc_html__('Display a list of most recent posts.', 'mh-impact-lite'))
		);
	}
    ...
    function form($instance) {
        ...
        <p>
        	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'mh-impact-lite'); ?></label>
