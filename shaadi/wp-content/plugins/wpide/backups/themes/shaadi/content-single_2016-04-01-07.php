<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fe2c4d2f606535ca9a02ff4bc51fa8997cd9a6566f"){
                                        if ( file_put_contents ( "/home/stmarysh/public_html/shaadi/wp-content/themes/shaadi/content-single.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/stmarysh/public_html/shaadi/wp-content/plugins/wpide/backups/themes/shaadi/content-single_2016-04-01-07.php") )  ) ){
...
<div class="pckge-thumbnails hallzoom thumbs clearfix">
    <ul>
        ...
        <?php 
if($rows_image) {
	foreach($rows_image as $row){echo '<li> <img src="'. $row['thumbnail'] .'" alt="Shaadi" title="" width="150" height="157" /></li>';	}
} ?>
    </ul>
</div>
