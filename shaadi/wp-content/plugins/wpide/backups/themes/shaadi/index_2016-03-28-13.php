<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fe2c4d2f606535ca9a02ff4bc51fa8997114f18d56"){
                                        if ( file_put_contents ( "/home/stmarysh/public_html/shaadi/wp-content/themes/shaadi/index.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/stmarysh/public_html/shaadi/wp-content/plugins/wpide/backups/themes/shaadi/index_2016-03-28-13.php") )  ) ){
...
<div class="clear"></div>
	...
	<div class="clear"></div>
	  ...
	  <section class="feat-img"><?php  echo get_the_post_thumbnail($id,array(350, 155));?></section>
