<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fe2c4d2f606535ca9a02ff4bc51fa8998877b9d64e"){
                                        if ( file_put_contents ( "/home/stmarysh/public_html/shaadi/wp-content/themes/shaadi/index.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/stmarysh/public_html/shaadi/wp-content/plugins/wpide/backups/themes/shaadi/index_2016-03-29-08.php") )  ) ){
...
<div class="search-container col-lg-12">
 ...
 <input type="submit" id="searchsubmit" value="Search" />
            ...
            <div class="searchforms">
            <p style=" font-size: 11px;margin: 0px;position: absolute; top: 15px; color: #fff;">Catering<p>
                <form action="">
            ...
            <div class="searchforms">
            <p style=" font-size: 11px;margin: 0px;position: absolute; top: 15px; color: #fff;">Decorator<p>
 <form method="get" id="advanced-searchform" role="search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
 <input type="hidden" name="search" value="advanced">
 <input type="text" value="" placeholder="Area" name="area" id="area"/>
 <input type="text" value="" placeholder="Number of Guests" name="guest" id="guest" />
