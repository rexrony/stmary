<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fe2c4d2f606535ca9a02ff4bc51fa8990f3e06bdd3"){
                                        if ( file_put_contents ( "/home/stmarysh/public_html/shaadi/wp-content/themes/shaadi/content-venue.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/stmarysh/public_html/shaadi/wp-content/plugins/wpide/backups/themes/shaadi/content-venue_2016-03-28-09.php") )  ) ){
...
<?php $index_query = new WP_Query(array( 'post_type' => 'featuredpackage', 'order' => 'DESC',  'posts_per_page' => 4 )); ?>
	  ...
	  <?php echo get_the_post_thumbnail($id,'full');?>
	   ...
	   <h2><?php the_title();?></h2>
	   <section class="venue-area"><?php the_field('tag_line', $id);?></section>
