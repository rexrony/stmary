<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fe2c4d2f606535ca9a02ff4bc51fa899eeddf1f480"){
                                        if ( file_put_contents ( "/home/stmarysh/public_html/shaadi/wp-content/themes/shaadi/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/stmarysh/public_html/shaadi/wp-content/plugins/wpide/backups/themes/shaadi/header_2016-03-31-07.php") )  ) ){
...
<head>
    ...
    <link href="<?php echo bloginfo( 'template_url' );?>/css/multizoom.css" rel="stylesheet">
    <script src="<?php echo get_template_directory_uri(); ?>/js/multizoom.js"></script>
    <script type="text/javascript">
jQuery(document).ready(function($){
    	$('#hallzoom').addimagezoom({ 
    	zoomrange: [3, 10],
