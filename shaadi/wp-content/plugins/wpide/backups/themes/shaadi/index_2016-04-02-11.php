<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "fe2c4d2f606535ca9a02ff4bc51fa8994480acf2c1"){
                                        if ( file_put_contents ( "/home/stmarysh/public_html/shaadi/wp-content/themes/shaadi/index.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/stmarysh/public_html/shaadi/wp-content/plugins/wpide/backups/themes/shaadi/index_2016-04-02-11.php") )  ) ){
...
<div id="main-index" class="maincontent">
...
<div class="clear"></div>
	...
	<div class="clear"></div>
	   <?php $index_query = new WP_Query(array( 'post_type' => 'allvenues', 'cat' => 4,  'posts_per_page' => 9, 'order' => 'ASC',  'posts_per_page' => 9 )); ?>
       <?php 
      $cou = 0;
      while ($index_query->have_posts()) : $index_query->the_post(); 
	  $id= get_the_ID();
