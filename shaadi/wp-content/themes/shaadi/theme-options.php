...
function theme_options_add_page() {
	add_theme_page( __( 'Theme Options', 'sampletheme' ), __( 'Customised', 'sampletheme' ), 'edit_theme_options', 'theme_options', 'theme_options_do_page' );
}
	...
	?>
        ...
        <form method="post" action="options.php" >
			...
			<table class="form-table">
                ...
                <tr valign="top"><th scope="row"><?php _e( 'contactus', 'sampletheme' ); ?></th>
					<td>
						<textarea id="cOptn[contactus]" class="large-text" cols="50" rows="10" name="cOptn[contactus]"><?php echo esc_textarea( $options['contactus'] ); ?></textarea>
						<label class="description" for="cOptn[contactus]"><?php _e( 'Footer contactus Text', 'sampletheme' ); ?></label>
					</td>
				</tr>
                <tr valign="top"><th scope="row"><?php _e( 'Address', 'sampletheme' ); ?></th>
					<td>
						<textarea id="cOptn[address]" class="large-text" cols="50" rows="10" name="cOptn[address]"><?php echo esc_textarea( $options['address'] ); ?></textarea>
						<label class="description" for="cOptn[address]"><?php _e( 'Footer Address Text', 'sampletheme' ); ?></label>
					</td>
				</tr>
